...
export class CQRSGraph {
     ...
     */
    public ApplyCommand(command : Commands.Command)
    {
        try
        {
            switch(command.type) {
     ...
     */
    public ApplyEvent(event : Events.Event)
    {
        try
        {
            switch(event.type)
     ...
     */
     protected AddConnector(action : Commands.AddConnectorCommand | Events.ConnectorAddedEvent) {
     ...
     */
    protected AddEdge(action : Commands.AddEdgeCommand | Events.EdgeAddedEvent) {
        if (this.graph.hasElement(action.elementId)) {
            throw new Error("ElementId is already in use");
        }
     ...
     */
    protected AddModel(action : Commands.AddModelCommand | Events.ModelAddedEvent) {
        if (this.graph.hasElement(action.elementId)) {
            throw new Error("ElementId is already in use");
        }
     ...
     */
    protected AddNode(action : Commands.AddNodeCommand | Events.NodeAddedEvent) {
        if (this.graph.hasElement(action.elementId)) {
            throw new Error("ElementId is already in use");
        }
        if (this.graph.hasModel(action.modelId) == false) {
     ...
     */
    protected DeleteConnector(action : Commands.DeleteConnectorCommand | Events.ConnectorDeletedEvent) {
     ...
     */
    protected DeleteEdge(action : Commands.DeleteEdgeCommand | Events.EdgeDeletedEvent) {
     ...
     */
    protected DeleteModel(action : Commands.DeleteModelCommand | Events.ModelDeletedEvent) {
     ...
     */
    protected DeleteNode(action : Commands.DeleteNodeCommand | Events.NodeDeletedEvent) {
     ...
     */
    protected DeleteConnectorProperty(action : Commands.DeleteConnectorPropertyCommand | Events.ConnectorPropertyDeletedEvent) {
        if (this.graph.hasConnector(action.elementId) == false) {
            throw new Error("No Connector with Id " + action.elementId + " exists");
        }
     ...
     * @param command DeleteModelCommand
     */
    protected DeleteEdgeProperty(action : Commands.DeleteEdgePropertyCommand | Events.EdgePropertyDeletedEvent) {
        if (this.graph.hasEdge(action.elementId) == false) {
            throw new Error("No Edge with Id " + action.elementId + " exists");
        }
        this.graph.deleteProperty(action.elementId, action.propertyName);
     ...
     * @param command DeleteModelCommand
     */
    protected DeleteModelProperty(action : Commands.DeleteModelPropertyCommand | Events.ModelPropertyDeletedEvent) {
        if (this.graph.hasModel(action.elementId) == false) {
            throw new Error("No Model with Id " + action.elementId + " exists");
        }
        this.graph.deleteProperty(action.elementId, action.propertyName);
     ...
     * @param command DeleteNodeCommand
     */
    protected DeleteNodeProperty(action : Commands.DeleteNodePropertyCommand | Events.NodePropertyDeletedEvent) {
        if (this.graph.hasNode(action.elementId) == false) {
            throw new Error("No Node with Id " + action.elementId + " exists");
        }
        this.graph.deleteProperty(action.elementId, action.propertyName);
     ...
     */
    protected SetConnectorProperty(action : Commands.SetConnectorPropertyCommand | Events.ConnectorPropertySetEvent) {
     ...
     */
    protected SetEdgeProperty(action : Commands.SetEdgePropertyCommand | Events.EdgePropertySetEvent) {
     ...
     */
    protected SetModelProperty(action : Commands.SetModelPropertyCommand | Events.ModelPropertySetEvent) {
     ...
     */
    protected SetNodeProperty(action : Commands.SetNodePropertyCommand | Events.NodePropertySetEvent) {
